...
type Task struct {
	...
	IncludeDownstream bool `protobuf:"varint,37,opt,name=include_downstream,json=includeDownstream,proto3" json:"include_downstream,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
